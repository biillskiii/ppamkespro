...
const EditBagian1 = () => {
  ...
  const [activeId, setActiveId] = useState("/admin/edit/bagian-2/assessment-5");
        ...
        <div className="container w-[1048px] ml-[344px] space-y-6 p-4">
          <div className="bg-[#1446AB] pl-4 py-4 rounded-2xl w-[1048px]">
            <p className="text-white font-extrabold text-xl">
              Komponen PPAM 5: Mencegah kehamilan yang tidak diinginkan(Edit
              Pertanyaan)
            </p>
          </div>
          <form
